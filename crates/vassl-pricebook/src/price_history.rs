use gpui::{
    div, prelude::*, px, rems, rgb, App, Context, IntoElement, MouseButton, MouseDownEvent, Render,
    Window,
};
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .text_size(rems(0.923))
                            .text_color(rgb(c.text_default))
                            .child(format!("${:.2}", e.cost_price_usd)),
                    )
                    .child(
                        div()
                            .w(px(80.))
                            .text_size(rems(0.923))
                            .text_color(rgb(c.text_muted))
                            .child(format!("+${:.2}", e.duty_cost_usd)),
                    )
                    .child(
                        div()
                            .w(px(70.))
                            .text_size(rems(0.923))
                            .text_color(rgb(c.text_muted))
                            .child(format!("{:.0}%", e.markup_percent)),
                    )
                    .child(
                        div()
                            .flex_1()
                            ...
                            .child(format!("${:.2}", e.selling_price_usd)),
                    )
            })
            .collect();
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .text_color(rgb(c.text_muted))
                            .child(format!(
                                "{entry_count} entries · {total_qty:.0} units total"
                            )),
                    ),
            )
    }
